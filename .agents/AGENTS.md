...
- Shows a fixed banner with a pulsing dot and inline Cancel button.
...
- `#ls-banner` — fixed top-right panel showing scraping status, a pulsing dot, and a Cancel button.
