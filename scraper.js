  ...
  function showSelectionPanel(data, selector) {
    ...
    panel.innerHTML = `
      ...
      <div class="ls-panel-footer">
        <button class="ls-action-btn ls-sponsor-btn" id="ls-sponsor-btn" title="Buy me a coffee">
          <svg width="12" height="17" viewBox="0 0 884 1279" fill="none" xmlns="http://www.w3.org/2000/svg">
